/*
 * @FileName HDFSVerification: To operate HDFS service
 * @outhor davieyang
 * @create 2018-08-20 11:23
 */
package util.paas;
...
public class HDFSVerification {

    private static String uri = "hdfs://192.168.1.118:9000";
    ...
    public static boolean append(String hdfsFile, String content) throws Exception {
        ...
        if (fs.exists(path)) {
            ...
            HDFSVerification.createNewHDFSFile(hdfsFile, content);
        }
        return true;
    }
